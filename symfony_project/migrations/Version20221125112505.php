 ...
 */
final class Version20221125112505 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE channel ADD name VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE users_id users_id LONGTEXT NOT NULL COLLATE `utf8mb4_unicode_ci` COMMENT \'(DC2Type:array)\'');
